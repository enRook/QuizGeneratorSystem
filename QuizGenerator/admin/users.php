...
<?php
					while($row = mysqli_fetch_array($result)){   //Creates a loop to loop through results
							echo "<tr><td>" . $row['id'] . "</td><td>" . $row['name'] . "</td><td>" . $row['regno'] . "</td><td>" . $row['pass'] . "</td><td>" . $row['role'] . "</td><td>Active</td>
					...
					while($row = mysqli_fetch_array($reslt)){   //Creates a loop to loop through results
							echo "<tr><td>" . $row['id'] . "</td><td>" . $row['name'] . "</td><td>" . $row['regno'] . "</td><td>" . $row['pass'] . "</td><td>Student</td><td>Active</td>
							<td><div class='field-actions'><div class='btn-group'>
							<form action='users.php' method='post'>
